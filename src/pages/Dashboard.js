...
const Dashboard = () => {
   ...
   const defaultCandleStickChartData = {
      series: [{
          data: [{
   ...
   const addTab = (title,content) => {
    ...
    const onChangeTab = (index,lastIndex,event) => {
      let elemId = tabs[index].chartId
      let elem = document.querySelector(`#${elemId}`)
      console.log({elemId,elem})

      let chart = new ApexCharts(elem,defaultCandleStickChartData)
      chart.render()
    }
